...
const complete_user_profile_dto_1 = require("./dto/complete-user-profile.dto");
...
let UsersController = class UsersController {
    ...
    async completeProfile(user, file, dto) {
...
__decorate([
    ...
    (0, common_1.Post)('complete-profile/owner'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.UploadedFile)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, complete_user_profile_dto_1.CompleteUserProfileDto]),
